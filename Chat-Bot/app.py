...
st.set_page_config(page_title="ProjectGPT 🔬🤖", page_icon="📚")
...
st.title("ProjectGPT 🔬🤖")
st.caption("Upload a Project Requirements and start chatting!")
...
# **🔹 Step 2: Load and Process PDF using PyPDFLoader**
